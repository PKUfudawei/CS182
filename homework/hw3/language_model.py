...
class LanguageModel(nn.Module):
    def __init__(self, vocab_size, rnn_size, num_layers=1, dropout=0):
        ...
        self.lstm = nn.LSTM(input_size=rnn_size, hidden_size=rnn_size, num_layers=num_layers, bias=True, dropout=dropout)
...
#         self.dropout = your_code
        ...
        self.output = nn.Linear(in_features=rnn_size, out_features=vocab_size, bias=True)
